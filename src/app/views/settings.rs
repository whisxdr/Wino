...
pub fn render(ui: &mut Ui, state: &mut AppState) {
    ...
    card_container(ui, |ui| {
        ui.horizontal(|ui| {
            ...
            ui.label(
                RichText::new(tr(lang, "set.appearance"))
                    .size(15.0)
                    .strong(),
            );
        });
        ...
        ui.horizontal(|ui| {
            ...
            let dark_btn = Button::new(RichText::new("🌙 Dark").color(if is_dark {
                Color32::WHITE
            } else {
            ...
            let light_btn = Button::new(RichText::new("☀️ Light").color(if is_light {
                Color32::WHITE
            } else {
                colors.text_secondary
            }))
        ...
        ui.horizontal(|ui| {
            ...
            let en_btn = Button::new(RichText::new("English 🇺🇸").color(if is_en {
                Color32::WHITE
            } else {
                colors.text_secondary
            }))
            ...
            .stroke(Stroke::new(
                1.0_f32,
                if is_en { colors.accent } else { colors.border },
            ))
            .rounding(Rounding::same(6.0))
            ...
            let id_btn = Button::new(RichText::new("Bahasa Indonesia 🇮🇩").color(if is_id {
                Color32::WHITE
            } else {
                colors.text_secondary
            }))
            ...
            .stroke(Stroke::new(
                1.0_f32,
                if is_id { colors.accent } else { colors.border },
            ))
            .rounding(Rounding::same(6.0))
        ...
        ui.add_space(4.0);
        ui.label(
            RichText::new(tr(lang, "set.language_hint"))
                .size(11.0)
    ...
    card_container(ui, |ui| {
        ui.horizontal(|ui| {
            ...
            ui.label(
                RichText::new(tr(lang, "set.auto_trim_section"))
                    .size(15.0)
                    .strong(),
            );
        });
        ...
        if ui
            .checkbox(&mut enabled, tr(lang, "set.auto_trim_enable"))
            .changed()
        {
        ...
        ui.horizontal(|ui| {
            ui.label(
                RichText::new(tr(lang, "set.auto_trim_threshold"))
                    .size(12.0)
                    .color(colors.text_secondary),
            );
            let mut pct = state.config.memory.auto_trim_threshold_pct;
            let slider = Slider::new(&mut pct, 60.0..=95.0)
                .suffix("%")
        ...
        ui.add_space(2.0);
        ui.label(
            RichText::new(tr(lang, "set.auto_trim_cooldown"))
                .size(11.0)
                .color(colors.text_muted),
        );
    });
    ...
    card_container(ui, |ui| {
        ui.horizontal(|ui| {
            ...
            ui.label(
                RichText::new(tr(lang, "set.privileges"))
                    .size(15.0)
                    .strong(),
            );
        });
        ...
        if !state.sys_info.is_admin {
            ui.add_space(8.0);
            ui.label(
                RichText::new(tr(lang, "set.elevate_note"))
                    .size(12.0)
                    .color(colors.text_muted),
            );
            ui.add_space(6.0);
            let elevate_btn = Button::new(
                RichText::new(format!("⚡ {}", tr(lang, "set.restart_admin")))
                    .strong()
                    .color(Color32::WHITE),
            )
            .fill(colors.accent)
    ...
    card_container(ui, |ui| {
        ...
        ui.add_space(4.0);
        ui.label(
            RichText::new("Wino — Rust-Native Windows Debloater, Optimizer & Memory Suite")
                .strong(),
        );
        ui.label(
            RichText::new(tr(lang, "set.about_version"))
                .size(11.0)
                .color(colors.text_muted),
        );
        ui.add_space(2.0);
        ui.label(
            RichText::new(tr(lang, "set.license_line"))
                .size(11.0)
                .color(colors.text_muted),
        );
    });
